...
public class Step6 {
    ...
    static class Step6_Mapper extends
        ...
        protected void map(LongWritable key, Text value, Context context)
            ...
            String num = tokens[2];
            PairWritable k = new PairWritable(); // 自定义的排序对象 二次排序
            k.setUid(u);
            k.setNum(Double.parseDouble(num));
            V.set(music + ":" + num);
            System.out.println(k.getUid()+" "+V.toString());
            context.write(k, V);
        }
    }
    ...
    static class NumSort extends WritableComparator {
        ...
        public int compare(WritableComparable a, WritableComparable b) {
            ...
            if (r == 0) {
                return -Double.compare(o1.getNum(), o2.getNum());//添加-号就是降序排列
            }
            return r;
        }
    }
